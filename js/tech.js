...
(function () {
  const extras = {
    zh: {
      ...
      "tech.p1.t":          "图像定位",
      "tech.p1.b":          "自适应分割 → 形态学处理 → 透视校正 → 朝向自动判定。处理 8K×13K 大分辨率工业图像,~0.5s/张。",
      "tech.p2.t":          "目标切割",
      "tech.p2.b":          "深度检测分割模型,关键部件 bbox 输出。mAP50 = 99.2%,单图 ~52ms (CPU)。",
      "tech.p3.t":          "缺陷判定",
      "tech.p3.b":          "深度分类 + 基准对比 + 经典异常检测 + 频域分析 — 四路并行,任一触发即标 NG。",

      "tech.moat.eyebrow":  "// Differentiation",
      "tech.moat.title":    "技术壁垒 · 我们的差异化优势",
      "tech.moat.m1.t":     "多路融合算法",
      "tech.moat.m1.b":     "深度学习 + 基准对比 + 经典视觉 + 频域分析,四路并行,任一触发即标 NG。召回率 +18%,显著降低漏检。",
      "tech.moat.m2.t":     "浏览器端推理",
      "tech.moat.m2.b":     "自研浏览器推理引擎 · 零服务端部署,数据不出厂、不上云。同时支持 GPU 服务器和边缘盒子。",
      "tech.moat.m3.t":     "工业图像专精",
      "tech.moat.m3.b":     "8192×13000 大分辨率 TIF 端到端处理 3 秒级,这是通用大模型难以做到的。",
      "tech.moat.m4.t":     "基准对比体系",
      "tech.moat.m4.b":     "部件 ID 识别 → 自动匹配基准模板 → 像素级差异检测,微小瑕疵召回率显著提升。",

      "tech.metrics.eyebrow":"// Production Numbers",
      "tech.metrics.title":  "生产环境指标",
      "tech.m.acc":          "Top-1 缺陷分类准确率",
      "tech.m.map":          "目标检测 mAP50",
    ...
    en: {
      ...
      "tech.l1.t":          "Classical CV · template matching · morphology",
      ...
      "tech.l2.t":          "Deep detection + classification + in-house pixel-level diff",
      ...
      "tech.l3.t":          "Vision-language model · domain fine-tuning · retrieval augmentation",
      ...
      "tech.p1.b":          "Adaptive segmentation → morphology → perspective correction → auto orientation. Handles 8K×13K industrial captures at ~0.5s each.",
      "tech.p2.t":          "Target Segmentation",
      "tech.p2.b":          "Deep detection + segmentation network, bbox output for parts. mAP50 = 99.2%, ~52ms on CPU.",
      "tech.p3.t":          "Defect Classification",
      "tech.p3.b":          "Deep classifier + reference-pattern diff + classical anomaly detection + frequency-domain analysis — four routes in parallel, any positive flags NG.",

      "tech.moat.eyebrow":  "// Differentiation",
      "tech.moat.title":    "What Sets Us Apart",
      "tech.moat.m1.t":     "Multi-Route Fusion",
      "tech.moat.m1.b":     "Deep learning + reference comparison + classical CV + frequency-domain analysis, four routes in parallel; any positive flags NG. +18% recall on subtle defects.",
      "tech.moat.m2.t":     "Edge / In-Browser Inference",
      "tech.moat.m2.b":     "In-house in-browser inference engine — zero-server deployment. Data never leaves the factory. Supports GPU servers and edge boxes too.",
      "tech.moat.m3.t":     "Industrial-Image Specialism",
      "tech.moat.m3.b":     "8192×13000 TIF end-to-end in ~3 seconds — something off-the-shelf large vision models can't match.",
      "tech.moat.m4.t":     "Reference-Pattern System",
      "tech.moat.m4.b":     "Part ID recognition → auto-match reference template → pixel-level diff. Significantly higher recall on subtle defects.",

      "tech.metrics.eyebrow":"// Production Numbers",
      "tech.metrics.title":  "Production Metrics",
      "tech.m.acc":          "Top-1 Classification Accuracy",
      "tech.m.map":          "Detection mAP50",
